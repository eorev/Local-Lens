...
const ShuffleHero = () => {
    return (
        <section className="w-full px-8 py-12 grid grid-cols-1 md:grid-cols-2 items-center gap-8 max-w-6xl mx-auto bg-background text-copy">
            <div>
                ...
                <p className="text-base md:text-lg my-4 md:my-6">
                    Understand your local politicians and how you can leverage your rights to vote.
                </p>
